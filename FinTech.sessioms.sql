...
INSERT INTO customers (last_name, first_name, email, phone, gender, city, country, zip_code, approved_by)
VALUES 
('Smith', 'John', 'john.smith@example.com', '123-456-7890', 'M', 'Gingoog', 'Philippines', '9014', 1),
('Doe', 'Jane', 'jane.doe@example.com', '234-567-8901', 'F', 'Los Angeles', 'USA', '90001', 2),
('Brown', 'Michael', 'michael.brown@example.com', '345-678-9012', 'M', 'Makati', 'Philippines', '1017  ', 3);
